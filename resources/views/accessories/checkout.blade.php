       ...
       <div class="box-body">
         ...
         @if ($accessory->category)
          ...
          <!-- checkout selector -->
             ...
             @include ('partials.forms.edit.user-select-scan-qr', ['translated_name' => trans('general.user'), 'company_id' => $accessory->company_id, 'fieldname' => 'assigned_user', 'style' => session('checkout_to_type') == 'user' ? '' : 'display: none;'])
