...
@section('content')
                                ...
                                <fieldset name="login" aria-label="login">
                                    ...
                                    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                        ...
                                        <div class="form-control radius input-style-ff" style="display: flex; align-items: center; position: relative;">
                                            <input style="border: none; outline-style: none; flex-grow: 1;" placeholder="{{ trans('admin/users/table.password')  }}" name="password" type="password" id="password" autocomplete="{{ (config('auth.login_autocomplete') === true) ? 'on' : 'off'  }}">
                                            <div style="cursor: pointer">
                                                ...
                                                <svg id="eyeOpen" width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // show closed-eye / hide open-eye by default
