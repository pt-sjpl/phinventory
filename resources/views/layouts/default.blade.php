...
<div class="wrapper">
          ...
          @if ($snipeSettings->brand == '3')
            <a class="logo navbar-brand no-hover" href="{{ config('app.url') }}">
              @if ($snipeSettings->logo != '')
                <img class="navbar-brand-img" src="{{ Storage::disk('public')->url($snipeSettings->logo) }}"
        ...
        <ul class="nav navbar-nav">
          @can('index', \App\Models\Asset::class)
            <li aria-hidden="true"{!! Request::is('hardware*') ? ' class="active"' : '' !!}>
              <a href="{{ url('hardware') }}" {{ $snipeSettings->shortcuts_enabled == 1 ? 'accesskey=1' : '' }}
                tabindex="-1" data-tooltip="true" data-placement="bottom" data-title="{{ trans('general.assets') }}">
          ...
          @can('view', \App\Models\License::class)
            <li aria-hidden="true"{!! Request::is('licenses*') ? ' class="active"' : '' !!}>
              <a href="{{ route('licenses.index') }}" {{ $snipeSettings->shortcuts_enabled == 1 ? 'accesskey=2' : '' }}
                tabindex="-1" data-tooltip="true" data-placement="bottom" data-title="{{ trans('general.licenses') }}">
          ...
          @can('index', \App\Models\Accessory::class)
            <li aria-hidden="true"{!! Request::is('accessories*') ? ' class="active"' : '' !!}>
              <a href="{{ route('accessories.index') }}"
                {{ $snipeSettings->shortcuts_enabled == 1 ? 'accesskey=3' : '' }} tabindex="-1" data-tooltip="true"
                data-placement="bottom" data-title="{{ trans('general.accessories') }}">
          ...
          @can('index', \App\Models\Consumable::class)
            <li aria-hidden="true"{!! Request::is('consumables*') ? ' class="active"' : '' !!}>
              <a href="{{ url('consumables') }}" {{ $snipeSettings->shortcuts_enabled == 1 ? 'accesskey=4' : '' }}
                tabindex="-1" data-tooltip="true" data-placement="bottom"
          ...
          @can('view', \App\Models\Component::class)
            <li aria-hidden="true"{!! Request::is('components*') ? ' class="active"' : '' !!}>
              <a href="{{ route('components.index') }}"
                {{ $snipeSettings->shortcuts_enabled == 1 ? 'accesskey=5' : '' }} tabindex="-1" data-tooltip="true"
                data-placement="bottom" data-title="{{ trans('general.components') }}">
                        ...
                        <a href="{{ route($alert_items[$i]['type'] . '.show', $alert_items[$i]['id']) }}">
                          ...
                          <div class="progress xs">
                            <div class="progress-bar progress-bar-yellow"
                              style="width: {{ $alert_items[$i]['percent'] }}%" role="progressbar"
                              aria-valuenow="{{ $alert_items[$i]['percent'] }}" aria-valuemin="0" aria-valuemax="100">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree"
        ...
        @can('index', \App\Models\Asset::class)
          ...
          <li id="byod-sidenav-option"{!! Request::query('status') == 'byod' ? ' class="active"' : '' !!}><a href="{{ url('hardware?status=byod') }}">
              <x-icon type="x" class="text-red fa-fw" />
              {{ trans('general.byod') }}
              <span class="badge">{{ isset($total_byod_sidebar) ? $total_byod_sidebar : '' }}</span>
            </a>
          </li>
          <li id="archived-sidenav-option"{!! Request::query('status') == 'Archived' ? ' class="active"' : '' !!}><a href="{{ url('hardware?status=Archived') }}">
              <x-icon type="x" class="text-red fa-fw" />
  ...
  <footer class="main-footer hidden-print" style="display:grid;flex-direction:column;">
    ...
    <div class="1hidden-xs pull-left">
      <div class="pull-left">
        <a target="_blank" href="https://snipeitapp.com" rel="noopener">Snipe-IT</a> is open source software, made
        with <x-icon type="heart" style="color: #a94442; font-size: 10px" />
