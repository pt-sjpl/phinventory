            ...
            <div class="box box-default">
                <form class="form-horizontal" method="post" action="" autocomplete="off">
                    ...
                    <div class="box-body">
                        ...
                        @include ('partials.forms.edit.user-select-scan-qr', ['translated_name' => trans('general.user'), 'fieldname' => 'assigned_user', 'style' => session('checkout_to_type') == 'user' ? '' : 'display: none;'])
